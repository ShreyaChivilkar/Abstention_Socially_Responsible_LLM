...
LOG_ROOT="${LOG_ROOT:-$ROOT_DIR/logs/sft_small_qwen_gemma}"
...
echo "[$(timestamp)] Running small-model LoRA SFT pipeline (Qwen + Gemma only)"
...
echo "[$(timestamp)] Qwen + Gemma small-model LoRA runs completed successfully"
